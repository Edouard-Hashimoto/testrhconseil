...
const homePresP1 = computed(() => settings.value?.home_pres_p1 || 'Cabinet à taille humaine, RH CONSEIL 71 a été créé en 2004. Nous accompagnons les entreprises dans la recherche de performance et le développement des compétences dans les domaines RH, RECRUTEMENT et QHSE.')
