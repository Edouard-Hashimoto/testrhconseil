...
import { l as joinRelativeURL, b as useRuntimeConfig, m as getResponseStatusText, o as getResponseStatus, p as defineRenderHandler, a as getQuery, c as createError, q as destr, t as getRouteRules, v as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"RH Conseil 71"};
